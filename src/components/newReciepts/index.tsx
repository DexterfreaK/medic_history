...
function Sidebar(props: SidebarProps) {
  ...
  useEffect(() => {
    axios
      .get(
        `https://mercor-backend-suhb.onrender.com/scrape/?format=json&searchitem=allegra`
      )
      .then((res) => {
...
function Drug(props: any) {
  return (
    <div className="block bg-white w-[12vw] p-2 text-[#545FDD] border border-[#545FDD] rounded-lg shadow flex justify-between">
      <h5 className="mb-2 text-md font-bold tracking-tight ">Allegra</h5>
      {/* <Image
        src="https://png.pngtree.com/png-clipart/20190617/original/pngtree-red-medicine-bottle-beautiful-medicine-bottle-cartoon-pill-bottle-red-yellow-png-image_3865704.jpg"
        alt="Pill"
        height={8}
        width={40}
      /> */}
            ...
            <div className="my-[4vh]">
              <form>
                <div className="mb-6 flex">
                  ...
                  <div className="text-sm font-bold text-gray-900">{uuid}</div>
                </div>
